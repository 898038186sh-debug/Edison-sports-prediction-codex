...
This plugin provides the `sports-prediction` skill. It guides an AI agent through a responsible pre-match analysis workflow covering:
...
- A betting advice product
- A financial advice product
- A gambling recommendation system
- A live-data provider by default
- A replacement for professional judgment
- An outcome-assurance system
